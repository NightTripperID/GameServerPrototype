...
import com.github.nighttripperid.littleengine.newstuff.Entity;
...
public class ScreenBufferUpdater {
    ...
    public void renderTilesToScreenBuffer(GameMap gameMap) {
        ...
        int x0 = (int) gameMap.getXScroll() >> gameMap.getTileBitShift();
        int x1 = (((int) gameMap.getXScroll() + screenBuffer.getWidth()) + gameMap.getTileSize())
                >> gameMap.getTileBitShift();
        int y0 = (int) gameMap.getYScroll() >> gameMap.getTileBitShift();
    ...
    public void renderTile(int xPos, int yPos, Tile tile) {
        ...
        xPos -= screenBuffer.getXScroll();
        yPos -= screenBuffer.getYScroll();
