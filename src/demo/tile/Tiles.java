...
public class Tiles {
    ...
    public static Tile dirtTile = new DemoTile(TileSprites.dirt, false, "dirt");
    ...
    public static Tile pillarTopTile = new DemoTile(TileSprites.pillarTop, true, "pillarTop");
    public static Tile pillarSideTile = new DemoTile(TileSprites.pillarSide, true, "pillarSide");
    public static Tile stoneFloorTile = new DemoTile(TileSprites.stoneFloor, false);
    public static Tile stoneDoorwayTile = new DemoTile(TileSprites.stoneDoorway, true, true, "door");
