...
public class Tiles {
    ...
    public static Tile dirtThreshold = new DemoTile(TileSprites.DIRT, false, true);
    ...
    public static Tile dungeonGate = new DemoTile(TileSprites.DUNGEON_GATE, true, true);
    public static Tile earthSide = new DemoTile(TileSprites.EARTH_SIDE, true);
    public static Tile earthTop = new DemoTile(TileSprites.EARTH_TOP, true);
    public static Tile floorSwitchUp = new DemoTile(TileSprites.FLOOR_SWITCH_UP, false, true);
    public static Tile floorSwitchDown = new DemoTile(TileSprites.FLOOR_SWITCH_DOWN, false);
    public static Tile grave = new DemoTile(TileSprites.GRAVE, true);
    public static Tile lava = new LavaTile();
    public static Tile lavaGrate = new DemoTile(TileSprites.LAVA_GRATE, false);
    public static Tile obeliskBottom = new DemoTile(TileSprites.OBELISK_BOTTOM, true);
    public static Tile obeliskTop = new DemoTile(TileSprites.OBELISK_TOP, true);
    ...
    public static Tile sand = new DemoTile(TileSprites.SAND, false);
    ...
    public static Tile wideDoorCenter = new DemoTile(TileSprites.WIDE_DOOR_CENTER, true);
    public static Tile wideDoorLeft = new DemoTile(TileSprites.WIDE_DOOR_LEFT, true);
    public static Tile wideDoorRight = new DemoTile(TileSprites.WIDE_DOOR_RIGHT, true);
